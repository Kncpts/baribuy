...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        if (Auth::user()->admin) {
            ...
            return redirect()->route('admin.dashboard')->with('msg_success', 'User Created Successfully');
        } else {
            return redirect('/home');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        if (Auth::user()->admin) {
            ...
            return redirect()->route('admin.dashboard')->with('msg_success', 'User Updated Successfully');
        } else {
            return redirect('/home');
        }
    }
    ...
    public function destroy($id)
    {
        if (Auth::user()->admin) {
            ...
            $role->delete();
            $user->delete();
            return redirect()->route('admin.dashboard')->with('msg_success', 'User Deleted Successfully');
        } else {
            return redirect('/home');
        }
    }
