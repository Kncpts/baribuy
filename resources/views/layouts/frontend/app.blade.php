...
<head>
    ...
    {{-- <link rel="stylesheet" href="{{ asset('frontend/assets/bootstrap-icons/font/css/bootstrap-icons.css') }}"> --}}
                ...
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center my-5 py-5">
                        <div class="left--text">
                            ...
                            <a href="{{ route('listings') }}" class="primary--btn mb-2 d-inline-block mt-3">
                                Start Here
                            </a>
                        </div>
