            ...
            <div class="col-lg-12">
                <ul class="list-group list-group-numbered mb-5">
                    <li class="bordered-li d-flex justify-content-between align-items-start">
                        ...
                        <a href="/account-input" class="badge bg-primary rounded-1 p-3 text-light"><i class="fa-solid fa-chevron-right"></i></a>
                    </li>
                    <li class="bordered-li d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                        ...
                        <a href="/emailverify" class="badge bg-primary rounded-1 p-3 text-light">Resend</a>
                    </li>
                    <li class="bordered-li d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                        ...
                        <a href="/resetpassword" class="badge bg-primary rounded-1 p-3 text-light">Change</a>

                    </li>
                    <li class="bordered-li d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                            <div class="fw-bold">Finish Account Setup</div>
                           
                        </div>
                        <a href="/register" class="badge bg-primary rounded-1 p-3 text-light"><i class="fa-solid fa-chevron-right"></i></a>
