        ...
        <div class="inner--rightsidebar">
            <div class="top--bar">
                ...
                <div class="text-center">
                    ...
                    <h5 class="title--center">Toqeer Haider</h5>
                    <h5 class="title--amount">$Toqeer Haider</h5>
                </div>
                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                        ...
                        <div class="details--section">
                            ...
                            <span class="title--value">
                                {{ $user->backup_tax_withholding_exempt == 1 ? 'Yes' : 'No' }}
                            </span>
                        </div>
                        <div class="details--section">
                            <span class="title">
                            ...
                            <span class="title--value">
                                {{ $user->accredited_investor == 1 ? 'Yes' : 'No' }}
                            </span>
                        </div>
                        <div class="details--section">
                            <span class="title">
                            ...
                            <span class="title--value">
                                {{ currencyConverter($user->annual_income) }}
                            </span>
                        </div>
                        <div class="details--section">
                            <span class="title">
                            ...
                            <span class="title--value">
                                {{ currencyConverter($user->net_worth) }}
                            </span>
                        </div>
                        <p>
                    ...
                    <div class="tab-pane fade" id="contact-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
                        ...
                        <div class="details--section">
                            <table class="table">
                                ...
                                <tr>
                                    <td>
                                        <a target="_blank" href="{{ asset('uploads/userDocuments/' . $doc->file_name) }}">{{ $doc->name }}</a>
                                    </td>
                                    <td>{{ $doc->approved }}</td>
                                    <td><a href="{{ route('user.destroy', $doc->id) }}">Delete</a> </td>
                                </tr>
                                @endforeach
                                @endisset
                            </table>
